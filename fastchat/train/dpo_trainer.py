...
class DPOMultiTrainer(Trainer):
    ...
    def get_batch_loss_metrics(
        ...
        # temp_reward = torch.tensor(batch['reward']).to(losses.device)
        # final_losses = losses*temp_reward
        # final = final_losses.mean()
...
class Ours_DPOMultiTrainer(Trainer):
    r"""
    Initialize DPOTrainer.
